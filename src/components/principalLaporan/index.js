...
class LaporanRapor extends Component {
  constructor(props) {
    super(props);
            ...
            <div className="pcoded-inner-content">
              <div className="main-body">
                ...
                <div className="card p-20">
                  <span className="mb-4">
                    <strong className="f-w-bold f-18 fc-skyblue ">Laporan / Rapor</strong>
                              ...
                              bodyTabble.map((item, i) => {
                                ...
                                return (
                                  <tr style={{ borderBottom: '1px solid #DDDDDD' }}>
                                    ...
                                    <td className="fc-muted f-14 f-w-300 p-t-20" align="center" style={{ color: '#0091FF' }}>Detail</td>
                                  </tr>
                                )
                              })
                          }
