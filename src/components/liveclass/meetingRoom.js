                          ...
                          <div className="card p-20">
                            <div>
                              ...
                              <Tooltip title="MOM" arrow placement="top">
                                ...
                                <span style={{ marginRight: 14, cursor: 'pointer', padding: '0px !important', height: '40px !important', width: '40px !important', borderRadius: '50px !important', border: this.state.newFileShow ? '4px solid #12db9f' : 'none' }} onClick={() => this.setState({ modalMOM: true })} className="float-right m-b-10">
                                  <img
                              ...
                              <Tooltip title="File Sharing" arrow placement="top">
                                ...
                                <span style={{ marginRight: 14, cursor: 'pointer', padding: '0px !important', height: '40px !important', width: '40px !important', borderRadius: '50px !important', border: this.state.newFileShow ? '4px solid #12db9f' : 'none' }} onClick={() => this.setState({ modalFileSharing: true })} className="float-right m-b-10">
                                  <img
