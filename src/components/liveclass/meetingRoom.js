                        ...
                        <h3 className="f-20 f-w-800">
                          ...
                          <p className="fc-muted mt-1 mb-4">Moderator : {classRooms.name}</p> */}
                            <div style={{background:`url('newasset/loading.gif') center center no-repeat`}}>
                              <Iframe
                                id="iframemeeting"
                                url={this.state.isZoom ? this.state.zoomUrl : this.state.joinUrl} width="100%" height="600px" display="initial" frameBorder="0" allow="display-capture *; fullscreen *;geolocation *; microphone *; camera *;" position="relative" />
                            </div>
                          ...
                          <div className="col-sm-12" style={{ flex: 1, flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                            <div className="card" style={{ background: '#dac88c', flex: 1, alignItems: 'center', justifyContent: 'flex-start', flexDirection: 'row' }}>
                              ...
                              <div className="card-carousel col-sm-4">
                                ...
                                <Link onClick={this.confirmAttendance.bind(this, 'Hadir')} to="#" className="float-right btn btn-sm btn-icademy-green" style={{ padding: '5px 10px' }}> Be Present
                              </Link>
                              </div>
                            </div>
                          </div>
