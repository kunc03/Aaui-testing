											...
											<div className="row d-flex align-items-center">
												...
												<div className="col-xl-3 col-md-12">
													<div className="row align-items-center justify-content-center">
														<div className="col">
															{item.exam_publish == 0 ?
																<small className="f-w-600 f-16 text-c-grey-t "> Title </small>
																:
																<small className="f-w-600 f-16 text-c-grey-t " style={{ color: 'green' }}> Exams Aktif</small>}
										...
										<div className="col-xl-12 col-md-12">
											<div className="row align-items-center justify-content-center">
												<div className="col">
													...
													<h5 className="f-w-bold f-20 text-c-purple3">
														Add Exam{/*"Silahkan buat exam Anda"*/}
													</h5>
												</div>
											</div>
										</div>
