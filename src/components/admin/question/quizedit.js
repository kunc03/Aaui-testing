                ...
                <div className="page-wrapper">
                  <div className="row">
                    	...
                    	<Card>
                    		<Card.Body>
		                      <Form onSubmit={this.onSubmitFormAdd}>
													  ...
													  <Button onClick={this.props.history.goBack} variant="ideku" type="button" style={{marginLeft: '10px'}}>
													    Kembali
													  </Button>
													</Form>
                    		</Card.Body>
                    ...
                    <div className="col-xl-4">
                      ...
                      <Card>
                    		<Card.Body>
		                      <Button onClick={this.onClickAddQuestion} variant="ideku" type="button" >
												    Tambah Pilihan
												  </Button>
												  ...
												  <ol type="A" style={{marginTop: '10px', marginLeft: '-25px'}}>
												  	{
												  		this.state.pilihans.map((item) => (
								          					...
								          					<i onClick={this.handleEditOption} data-id={item.option_id} className="fa fa-edit"></i>
								        					</Link>
                      ...
                      <Modal.Body>
                      	<Form onSubmit={this.onSubmitFormPilihan}>
	                        <Form.Group controlId="formTag">
												    ...
												    <Form.Control value={this.state.pilihan} required name="pilihan" onChange={this.onChangeInput} type="text" placeholder="A, B, C, D, E..." />
												  </Form.Group>
												  <Form.Group controlId="formPertanyaan">
												    <Form.Label>Jawaban</Form.Label>
												    <Form.Control value={this.state.jawaban} required name="jawaban" onChange={this.onChangeInput} as="textarea" placeholder="jawaban" rows="3" />
												    <Form.Text>
												      Tuliskan jawabannya.
												    </Form.Text>
												  </Form.Group>
