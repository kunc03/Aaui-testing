...
export default class ChapterPreview extends Component {
  ...
  state = {
    ...
    steps: [
      {
        target: '.buat-chapter',
        content: 'The first thing to do is add chapters to this course.',
      },
      {
        target: '.buat-quiz',
        content: 'After the chapter has been created, you can create a quiz which will be followed by the participants.',
      },
      {
        target: '.buat-ujian',
        content: 'The final stage is to make the final examination of this course.',
      },
    ]
  }
  ...
  onSubmitChapterMeeting = e => {
    ...
    if (this.state.chapterId !== "") {
      ...
      if (this.state.chapterVideo !== "") {
        ...
        this.setState({ isNotifikasi: true, isiNotifikasi: 'Media chapters cannot be empty, they must be filled.' })
      }
    }
  }
                      ...
                      <Modal.Body>
                        ...
                        <Form>
                          ...
                          <Form.Group controlId="formTag">
                            ...
                            />
                            <Form.Text className="text-muted">
                              If more than 1 link with [enter]
                          </Form.Text>
                          </Form.Group>
                          ...
                          <DatePicker
                            ...
                            <Form.Text className="text-muted">
                              Select start and end times for the chapter.
                          </Form.Text>
                          </Form.Group>
