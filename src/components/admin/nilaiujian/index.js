					...
					<tbody>
					{
						lists.map((item, i) => (
							<tr key={item.course_id}>
								...
								<td>
									<Link to={`/chapter/${item.course_id}`} className="buttonku" title="Nilai Ujian">
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="row">
                                            <div className="col-xl-4 mb-3">
                                                <Link onClick={this.tabNilai.bind(this, 'quiz')}>
                                            ...
                                            <div className="col-xl-4 mb-3">
                                                <Link onClick={this.tabNilai.bind(this, 'ujian')}>
                                        ...
                                        <div className="row">
                                            <div className="col-xl-8 mb-3">
                                                <h3 className="f-24 f-w-800">Detail Nilai Kursus</h3>
                                            </div>
                                            <div className="col-xl-4 mb-3">
                                                     <Link
