...
class Login extends Component {
  ...
  render() {
    ...
    let formKu = null;
    let plainURL = this.props.redirectUrl.slice(1, 20) === 'meeting/information' ? decodeURIComponent(this.props.redirectUrl ? APPS_SERVER+'redirect'+this.props.redirectUrl : APPS_SERVER) : decodeURIComponent(this.props.redirectUrl ? APPS_SERVER+this.props.redirectUrl.slice(1, this.props.redirectUrl.length) : APPS_SERVER);
