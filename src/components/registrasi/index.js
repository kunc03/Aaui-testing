                  ...
                  <form onSubmit={this.saveKelas}>
                    ...
                    <div className="row mb-3">
                      ...
                      <div className="col">
                        ...
                        <input required value={this.state.tahunAjaran} onChange={e => this.setState({ tahunAjaran: e.target.value })} type="text" className="form-control" placeholder="Enter Academic Year" name="tahunAjaran" />
                      </div>
                    </div>
                    <div className="row">
                      <div className="col">
