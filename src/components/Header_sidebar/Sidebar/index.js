...
// }
  ...
  render() {
    ...
    let menuClients = {
      ...
      guru: {
        submenu: [
          { iconOn: 'people-on.svg', iconOff: 'people.svg', label: 'Personalia', link: '/guru-info/personalia' },
          { iconOn: 'matapelajaranon.svg', iconOff: 'graduate.svg', label: 'Kursus', link: '/guru-info/kursus' },
          { iconOn: 'tugason.svg', iconOff: 'tugasoff.svg', label: 'Exercise & Ujian', link: '/guru-info/ujian' },
          { iconOn: 'info-on.svg', iconOff: 'info.svg', label: 'Informasi Kelas', link: '/guru-info/informasi-kelas' },
          { iconOn: 'instructor-on.svg', iconOff: 'instructor.svg', label: 'KPI Guru', link: '/guru-info/kpi' },
          { iconOn: 'logout.svg', iconOff: 'logout.svg', label: 'Logout', link: '/logout' },
        ]
      },
