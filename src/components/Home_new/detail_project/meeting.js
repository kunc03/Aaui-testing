...
const styless: StyleSheet = {
  ...
  flexs: {
     flexGrow: 1,padding: 10, fontFamily:'Tahoma, Helvetica', fontSize:"14px", fontWeight:"bold", fontVariant:"small-caps", letterSpacing:"2px"
  },
  flex:{
    flexGrow: 1,padding: 0
  },
  display: {
    color:'white',   display: 'flex',padding: 15
  },
  input: {
    marginLeft: 8,
    flex: 1,
